...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="/build/app.css?v=3">
    </head>
    ...
    <section role="banner">
        <div class="logo">
            <figure>
                <img src="/img/logo-composer-transparent2.png"
            ...
            <p class="latest">Latest: <strong>2.10.2</strong> (<a href="/changelog/2.10.2" title="Changelog for version 2.10.2" aria-label="Changelog for version 2.10.2">changelog</a>)</p>
                    </div>
    </section>
    ...
    <p>
        Commercial support &amp; consulting available through:<br />
    ...
    <p>
        Logo by: <a href="https://github.com/MAXakaWIZARD"
                    title="Go to Max Grigorian's Github profile (external link)"
                    aria-label="Go to Max Grigorian's Github profile (external link)">Max Grigorian</a>
    </p>
